    ...
    <div className="font-sans text-dark">
          ...
          <div className="row align-items-center">
            <div className="col-md-6 mb-4 mb-md-0">
              ...
              <p className="lead mb-4">
                Acesso gratuito a psicólogos qualificados para quem precisa de apoio emocional mas não pode arcar com os custos tradicionais.
              </p>
              <div className="d-grid gap-2 d-sm-flex">
                <a href="#agendar" className="btn btn-light text-primary fw-bold">Agendar Consulta</a>
                <a href="#" className="btn btn-outline-light fw-bold">Saiba Mais</a>
              </div>
            </div>
      ...
      <section className="py-5 bg-light">
        <div className="container text-center mb-5">
          ...
          <p className="lead text-secondary">Um processo simples para você receber o atendimento psicológico que precisa</p>
        </div>
            ...
            {[
              ...
              <div className="col-md-4" key={index}>
                <div className="feature-card p-4 bg-white rounded shadow-sm text-center h-100">
                  <div className="bg-primary bg-opacity-10 rounded-circle d-inline-flex justify-content-center align-items-center mb-3" style={{ width: '64px', height: '64px' }}>
      ...
      <section className="py-5">
        <div className="container text-center mb-5">
          ...
          <p className="lead text-secondary">Profissionais qualificados e comprometidos com o bem-estar emocional</p>
        </div>
        <div className="container">
          <div className="row g-4">
            {[
              {
                ...
                stars: 4.5,
                description: 'Especialista em ansiedade e depressão, com abordagem humanista e 10 anos de experiência clínica.'
              },
              {
                ...
                stars: 5,
                description: 'Especializado em TCC para transtornos de ansiedade e fobias, com foco em soluções práticas.'
              },
              {
                name: 'Dra. Mariana Oliveira',
                subtitle: 'Psicóloga Infantil',
                image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5cd',
                tags: ['Crianças', 'Família', 'Atenção'],
                stars: 4.5,
                description: 'Atua com foco em crianças e adolescentes, promovendo o desenvolvimento emocional saudável em ambiente familiar.'
              }
            ].map((prof, index) => (
              <div className="col-md-4" key={index}>
                <div className="psychologist-card bg-white rounded shadow-sm overflow-hidden h-100">
                  <img src={prof.image} alt={prof.name} className="w-100" style={{ height: '250px', objectFit: 'cover' }} />
                  <div className="p-4">
                    <div className="d-flex justify-content-between align-items-start mb-3">
                      ...
                      <div className="text-warning">
                        ...
                        {prof.stars % 1 !== 0 && <i className="fas fa-star-half-alt"></i>}
                      </div>
                    </div>
                    <p className="text-muted">{prof.description}</p>
                    <div className="d-flex flex-wrap gap-2 mb-3">
                      {prof.tags.map((tag, i) => (
                        <span key={i} className="badge bg-primary bg-opacity-10 text-primary">{tag}</span>
                      ))}
                    </div>
                    <a href="#agendar" className="btn btn-primary w-100">Agendar Consulta</a>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-5 bg-light">
        <div className="container text-center mb-5">
          ...
          <p className="lead text-secondary">O que nossos usuários dizem sobre o PsicoAcolher</p>
        </div>
        <div className="container">
